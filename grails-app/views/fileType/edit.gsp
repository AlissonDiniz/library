...
<html>
    <head>
        ...
        <title><g:message code="menu.edit.fileType" /></title>
    </head>
    <body>
        <div id="legend-page" class="legend-page">
            <h3><g:message code="menu.edit.fileType" /></h3>
        </div>
        ...
        <g:form name="form" url="[resource:fileTypeInstance, action:'update']" method="PUT" >
            <g:hiddenField name="version" value="${fileTypeInstance?.version}" />
            <fieldset class="form">
                ...
                <div class="col-xs-12 form-group buttons">
                    ...
                    <button type="button" data-path="<g:createLink action="show" resource="${fileTypeInstance}" />" class="btn btn-warning redirect">
                        <span class="glyphicon glyphicon-remove-sign" aria-hidden="true"></span> <g:message code="default.button.cancel.label" />
                    </button>
                </div>
            </fieldset>
        </g:form>
        <g:form name="deleteForm" url="[resource:fileTypeInstance, action:'delete']" method="DELETE">
        </g:form>
    </body>
</html>
