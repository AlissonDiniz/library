...
<html>
    <head>
        ...
        <title><g:message code="menu.edit.publisher" /></title>
    </head>
    <body>
        <div id="legend-page" class="legend-page">
            <h3><g:message code="menu.edit.publisher" /></h3>
        </div>
        <ul class="nav nav-pills">
            <li role="presentation">
                <a href="<g:createLink action="index" />">
                    <i class="fa fa-fw fa-tasks"></i>
                    <g:message code="command.edit.publisher" />
                </a>
            </li>
        </ul>
        ...
        <g:form name="form" url="[resource:publisherInstance, action:'update']" method="PUT" >
            ...
            <fieldset class="form">
                ...
                <div class="col-xs-12 form-group buttons">
                    ...
                    <button type="button" data-path="<g:createLink action="show" resource="${publisherInstance}" />" class="btn btn-warning redirect">
                        <span class="glyphicon glyphicon-remove-sign" aria-hidden="true"></span> <g:message code="default.button.cancel.label" />
                    </button>
                </div>
            </fieldset>
        </g:form>
        <g:form name="deleteForm" url="[resource:publisherInstance, action:'delete']" method="DELETE">
        </g:form>
    </body>
</html>
