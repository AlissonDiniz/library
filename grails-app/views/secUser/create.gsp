...
<html>
    <head>
        ...
        <title><g:message code="menu.new.user" args="[entityName]" /></title>
    </head>
    <body>
        <div id="legend-page" class="legend-page">
            <h3><g:message code="menu.new.user" /></h3>
        </div>
        ...
        <g:form name="form" url="[resource:secUserInstance, action:'save']" role="form">
            <fieldset class="form">
