...
<html>
    <head>
        ...
        <title><g:message code="menu.new.file" /></title>
        <r:require module="file"/>
    </head>
    <body>
        <div id="legend-page" class="legend-page">
            <h3><g:message code="menu.new.file" /></h3>
        </div>
        ...
        <g:form name="form" url="[resource:fileInstance, action:'save']" >
            <fieldset class="form file-container">
